...
export default function Home() {
  ...
  return <main><header className="topbar"><div className="brand-mark">DF</div><div><strong>Memória Institucional</strong><span>Explorador de evidências oficiais</span></div><div className="edition-pill">DODF 112 · 22 JUN 2026</div></header>
